...
class EntityType(models.TextChoices):
    ...
    LINKED_CONTACT_COMPANY = "linked_contact_company", "Linked contact + company"
    LINKED_CONTACT_DEAL = "linked_contact_deal", "Linked contact + deal"
    LINKED_DEAL_COMPANY = "linked_deal_company", "Linked deal + company"
    LINKED_DEAL_CONTACT = "linked_deal_contact", "Linked deal + contact"
    TASK = "task", "Task"
