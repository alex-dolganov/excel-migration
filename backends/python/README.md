...
```bash
docker exec api-python-worker python manage.py test tests                  # все
docker exec api-python-worker python manage.py test tests.test_import_report_metadata  # один модуль
```
